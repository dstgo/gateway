...
import (
	...
	configure "github.com/dstgo/configure/api/configure/client"
	...
	_ "github.com/dstgo/gateway/discovery/consul"
	"github.com/dstgo/gateway/middleware"
	_ "github.com/dstgo/gateway/middleware/auth"
	_ "github.com/dstgo/gateway/middleware/bbr"
	"github.com/dstgo/gateway/middleware/circuitbreaker"
	_ "github.com/dstgo/gateway/middleware/cors"
	_ "github.com/dstgo/gateway/middleware/logging"
	_ "github.com/dstgo/gateway/middleware/rewrite"
	_ "github.com/dstgo/gateway/middleware/tracing"
	_ "github.com/dstgo/gateway/middleware/transcoder"
	"github.com/dstgo/gateway/proxy"
	"github.com/dstgo/gateway/proxy/debug"
	"github.com/dstgo/gateway/server"
)
